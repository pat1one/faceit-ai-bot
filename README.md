...
Инструмент для анализа статистики игроков CS2 на платформе Faceit. Помогает находить тиммейтов, анализировать демки и улучшать свою игру.

### ✨ Основные возможности

- 🤖 **Анализ игроков** — детальная статистика и рекомендации по улучшению
- 📊 **Интеграция с Faceit** — актуальные данные матчей и игроков
- 📈 **Анализ демо-файлов** — разбор игровых моментов
- 👥 **Поиск тиммейтов** — подбор напарников по стилю игры
- 💡 **Планы тренировок** — персональные программы развития
- 🔮 **Прогнозы матчей** — предсказание результатов
...
### v0.3.0 (В разработке)
- [ ] Улучшенный анализ с историей матчей
- [ ] Интеграция с Steam
- [ ] Система достижений
