...
**Copyright © 2025 pattmsc (Platon). All Rights Reserved.**

Этот проект защищён авторским правом. Копирование, модификация и коммерческое использование запрещены без письменного разрешения автора.

Разрешено:
- ✅ Личное использование приложения на https://pattmsc.online
