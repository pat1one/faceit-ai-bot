...
Этот проект распространяется под лицензией MIT с дополнительными условиями против воровства кода.
...
Обязательно:
- ⚠️ Указывать автора оригинала
- ⚠️ Отмечать внесённые изменения
- ⚠️ Не продавать прямые копии без модификаций
