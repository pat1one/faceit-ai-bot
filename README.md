...
AI-powered инструмент для анализа статистики игроков CS2 на платформе Faceit с использованием GPT-4. Помогает находить тиммейтов, анализировать демки и улучшать свою игру.
